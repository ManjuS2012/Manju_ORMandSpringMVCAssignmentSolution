package com.greatlearning.crmController;
...
import com.greatlearning.crmService.CustomerService;
...
public class CustomerController {
	...
	@GetMapping("/list")
	@Transactional
	public String showCustomers(Model model, @RequestParam(name = "sortby", required = false) String sortBy,
