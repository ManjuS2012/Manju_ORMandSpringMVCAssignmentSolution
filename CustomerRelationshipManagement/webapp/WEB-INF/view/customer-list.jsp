...
<%@ page import="com.greatlearning.crmUtil.SortUtils"%>
<!DOCTYPE html>
<html>
<head>
			...
			<table>
				<thead>
					<tr>
						...
						<th title="Sort by First Name"><a
							href="${sortByFirstNameLink}">First Name</a></th>
						<th title="Sort by Last Name"><a
							href="${sortByLastNameLink}">Last Name</a></th>
